                ...
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b border-b-gray-50">
                            ...
                            @else
                                <span class="inline-block p-1 rounded bg-green-500/10 text-green-500 font-medium text-[12px] leading-none">Traité</span>
                            @endif
                        </td>
                        <td class="py-2 px-4 border-b border-b-gray-50">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu shadow-md shadow-black/5 z-30 py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[180px] hidden" data-popper-id="popper-7" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-110px, 915px);" data-popper-placement="bottom-end">
                                    <li>
                                        <a href="{{ route('order.markAsTreated', $order->id) }}" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Marquer comme traité</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
